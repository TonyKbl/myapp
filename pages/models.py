...
class Page(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.SET(custom_user), related_name="user"
    )
    ...
    website = models.URLField(
        max_length=255, null=True, blank=True, validators=[validate_is_profane]
    )
...
class PageFollow(models.Model):
    follower = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="page_following"
    )
...
class PageHost(models.Model):
    ...
    page_name = models.ForeignKey(
        Page, on_delete=models.CASCADE, related_name="host_for"
    )
...
class PageReviews(models.Model):
    ...
    page_name = models.ForeignKey(
        Page, on_delete=models.CASCADE, related_name="reviewed_page"
    )
...
class ClaimPage(models.Model):
    claimant = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="claimant"
    )
    page_claimed = models.ForeignKey(
        Page, on_delete=models.CASCADE, related_name="claimed_page"
    )
