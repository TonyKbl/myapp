...
urlpatterns = [
    ...
    path(
        "edit_looking_for.html",
        views.LookingForUpdateView.as_view(),
        name="edit_profile",
    ),
    path(
        "edit_interests.html", views.InterestUpdateView.as_view(), name="edit_interests"
    ),
    path(
        "set_profile_type/", views.SetProfileTypeView.as_view(), name="set_profile_type"
    ),
    path(
    ...
    path(
        "gallery_upload/<str:username>/",
        views.ProfileAddGalleryView.as_view(),
        name="gallery_upload",
    ),
